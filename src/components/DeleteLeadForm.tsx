...
export default function DeleteLeadForm({ leadId }: DeleteLeadFormProps) {
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        if (!confirm("Are you sure you want to delete this lead? This action is permanent.")) {
            e.preventDefault();
        }
    };
    ...
    return (
        <div className="glass-card p-10 border-red-500/20 bg-red-500/5">
            ...
            <p className="text-xs text-zinc-500 mb-8 leading-relaxed">
                This action is permanent. All lead information will be deleted.
            </p>
